" Install ag with `yaourt -S ag`
" Install ripgrep with `yaourt -S ripgrep`
" let g:poject_folders = ['~/project', '~/workingspace']
call denite#custom#option('default', 'prompt', '➭ ')
call denite#custom#option('default', 'direction', 'rightbelow')
call denite#custom#option('default', 'highlight_matched_char', 'MoreMsg')
call denite#custom#option('default', 'highlight_matched_range', 'MoreMsg')
...
nnoremap <silent> <space>d  :<C-u>Denite directory_rec<cr>
" nnoremap <silent> <space>e  :<C-u>Denite buffer<cr>
nnoremap <silent> <space>f  :<C-u>Denite file/rec buffer<cr>
nnoremap <silent> <space>c  :<C-u>Denite change<CR>
...
"nnoremap <silent> <space>r  :<C-u>Denite redis_mru:.<cr> " maybe use LeaderF plugin
